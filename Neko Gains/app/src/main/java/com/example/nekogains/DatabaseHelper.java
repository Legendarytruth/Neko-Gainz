...
public class DatabaseHelper extends SQLiteOpenHelper implements Serializable {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE " + WORKOUT_CALENDAR_TABLE + " (DAY INTEGER, ID INTEGER PRIMARY KEY, WARMUP TEXT, WREPS TEXT, CARDIO TEXT, CREPS TEXT, ARMS TEXT, AREPS TEXT, CORE TEXT, COREPS TEXT, LEGS TEXT, LREPS TEXT," +
